...
export default function About() {
  ...
  return (
    <div className="container content-page">
      ...
      <p className="lede">
        Outcast G Store is a digital game store built for players who want genuine games at honest prices.
      ...
      <div className="content-block">
        <h2>What we do</h2>
        <p>
          We source official games directly from publishers and authorised distributors, then pass the
      ...
      <div className="content-block">
        <h2>Our promise</h2>
        <p>
          Genuine games, transparent pricing, and a support team that actually answers. If something's wrong with
