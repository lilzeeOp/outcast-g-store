# Chat greetings for Outcast G Store

Paste these into **Telegram Business → Greeting Message** (needs Telegram Premium)
and **WhatsApp Business → Business tools → Greeting message**. Both apps send the
greeting automatically the first time someone messages you.
...
https://outcast-g-store.vercel.app 🎮
```

## Away message (outside working hours)

```
🌙 Thanks for your message! We're away right now.

We reply every day between 10:00 and 23:00 IST. Your message is saved and we'll
confirm your order first thing. If it's urgent, please leave the game name and
we'll prioritise it. 🎮
```
